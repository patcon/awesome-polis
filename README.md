...
- 2025-04: [Partici.app: Demo](https://demo.partici.app/?base_url=https://api.partici.app/&conversation_id=8vwsnjphnz) - A "production" demo Partici.app frontend for Polis, accessed via the ParticiAPI server. Part of PolisNL project. [Source](https://gitlab.com/particiapp/particiapp-example-frontend)
...
- 2024-06: [PolisNL Demo](https://demo.partici.app/?base_url=https://api.partici.app/&conversation_id=8vwsnjphnz) - PolisNL is a demo Partici.app frontend for Polis, accessed via the ParticiAPI server. [Source](https://gitlab.com/betabreak/polispilot/demo)
...
- 2025-02: [Praat mee met de Overheid](https://pilot.praatmeemetdeoverheid.nl/) - A Polis implementation by the Dutch Ministry of the Interior and Kingdom Relations, where partici.app components where used. [Source](https://gitlab.com/particiapp/)
