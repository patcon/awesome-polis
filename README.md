...
- [Polis deployment: Crowd Wisdom Project](https://polis.crowdwisdomproject.org/home) - An unmodified deployment of the Polis codebase, hosted by the UK-based Crowd Wisdom Project. [Source](https://github.com/NewRedo/polis-fork)
- [Polis deployment: Polis.tw](https://polis.tw/home) - An slightly modified deployment of the Polis codebase, hosted by PDIS.tw, a division of the Taiwanese national government. [Source](https://github.com/PDIS/polis2023)
...
- 2024-05-09: [aadityabhatia/polis-argmap](https://argmap.bhatia.dev/) - Polis Argument Mapping to Guide Policy Decisions. How can large language models enable us to ingest massive streams of unstructured information, incorporate diverse perspectives and distill them into actionable insights that demonstrably align with public opinion? [Source](https://github.com/aadityabhatia/polis-argmap)
...
- [Demos-thinktank/dynata-id](https://github.com/Demos-thinktank/dynata-id) - A small site built to receive incoming Dynata ids, show people an embedded Pol.is survey, and send them back off when done.
...
- [joshsmith2/polis-loadtesting](https://github.com/joshsmith2/polis-loadtesting) - A series of Locust test to meaningfully load-test Pol.is instances
...
- [Partici.app](https://demo.partici.app/?base_url=https://api.partici.app/&conversation_id=8vwsnjphnz) - An Alternative Polis frontend, used in the PolisPilot demo. ([Kanban board](https://gitlab.com/betabreak/polispilot/polis-innovation/-/boards)) [Source](https://gitlab.com/particiapp/particiapp-example-frontend)
...
- [Participa app](https://participalab.uy/#polarizacion) - Alternative Polis administration app written in Python's Django framework. For self-hosted Polis conversations, aims to improve the interface, and add user management, without forking its Polis core. [Source](https://github.com/participa-lab/participa)
...
- [patcon/astro-test-polis](https://astro-test-polis.netlify.app/) - A sample wrapper app for a Polis conversation, built on Astro framework. [Source](https://github.com/patcon/astro-test-polis)
- [patcon/polis-examples](https://patcon.github.io/polis-examples/) - Minimal sample apps for demonstrating various sorts of integrations. Notably includes passing vote/submit messages out of iframe via postMessage, and using Auth0 accounts. [Source](https://github.com/patcon/polis-examples)
- [patcon/polis-exporter](https://github.com/patcon/polis-exporter) - An unfinished, messy work-in-progress set of scripts attempting to generate a Polis zipped export archive from public API endpoints.
- [patcon/polis-irl-simulator](https://github.com/patcon/polis-irl-simulator) - A demo to show how Polis conversations might augment in-person meetings.
- [patcon/trump-polis-twitter-bot](https://github.com/patcon/trump-polis-twitter-bot) - A Twitter bot to auto-create Pol.is conversations for each Donald Trump tweet.
- [PDIS/aframe-polis](https://github.com/PDIS/aframe-polis/) - An exploration of visualizing Polis results in the A-Frame web VR framework
...
- [Talk to Taiwan](https://web.archive.org/web/20170523073533/http://talkto.tw/talk/17) - Source for generating the [Talkto.tw website codebase](https://github.com/maylogger/talkto.tw), which used Polis alongside livestreamed interviews of public figures. [Source](https://github.com/maylogger/talkto.tw.source)
